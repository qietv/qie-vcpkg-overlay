...
elseif(MSVC_VERSION)
    ...
    foreach(_MILE_UNICRT_CHECK_VARIABLE IN ITEMS
        MILE_UNICRT_MSVC_TARGET_X86
        MILE_UNICRT_MSVC_TARGET_X64
        MILE_UNICRT_MSVC_TARGET_ARM64)
        unset("${_MILE_UNICRT_CHECK_VARIABLE}")
        unset("${_MILE_UNICRT_CHECK_VARIABLE}" CACHE)
    endforeach()
    unset(_MILE_UNICRT_CHECK_VARIABLE)
